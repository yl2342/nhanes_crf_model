...
## for training
data <- read.csv(paste0(raw_data_path, 'data_vo2max_all.csv'))
## for prediction
data4pred_16yrs <- read.csv(paste0(raw_data_path, 'data16_vo2max_all.csv'))
```
...
X_pred <- data4pred_16yrs %>% dplyr::select(-seqn)




##################################
## ALL dummies with missingness ##
##################################
...
write.csv(train_all_dummies,
          paste0(processed_data_path,'train_all_dummies.csv'),
          row.names = FALSE)
write.csv(test_all_dummies,
          paste0(processed_data_path,'test_all_dummies.csv'),
          row.names = FALSE)

write.csv(X_pred_all_dummies%>% mutate(seqn = data4pred_16yrs$seqn),
          paste0(processed_data_path,'X_pred_all_dummies.csv'),
          row.names = FALSE)
