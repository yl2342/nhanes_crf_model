...
sum(!is.na(cvx_combined$CVDESVO2))
...
data_vo2max_all <- data_eligible  %>% 
  ...
  right_join(cvx_combined, by = 'seqn') %>%
...
## basic version for parsimonious model 
...
write.csv(data16_vo2max_all, paste0(wd_path,'data16_vo2max_all_allage.csv'), row.names = F)
